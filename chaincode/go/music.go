...
func (s *SmartContract) initWallet(APIstub shim.ChaincodeStubInterface) pb.Response { //지초 초기화시 호출
...
func (s *SmartContract) setMusic(APIstub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	var music = Music{Title: args[0], Singer: args[1], Price: args[2], WalletID: args[3]} //파라미터 값들 json 변환
